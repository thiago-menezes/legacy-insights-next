# Legacy Insight - Authentication API Guide

This document describes the authentication endpoints provided by the Strapi backend for the Legacy Insight frontend application.
